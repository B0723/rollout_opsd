...
# Dynamic OPSD — Qwen3-4B  8 GPU  effective_bs=32
# Usage:
#   bash run_dynamic_4b.sh dynamic      # S_i = K_hat*(1-H_hat), Teacher full batch
#   bash run_dynamic_4b.sh dynamic_lh   # S_i = (1-L_hat)*(1-H_hat), Teacher on 50% only
MODE=${1:-dynamic}
